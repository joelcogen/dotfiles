...
export PATH=/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/X11/bin:$HOME/.rbenv/bin:/usr/local/share/npm/bin:/Users/jole/dev/platform-tools:/usr/local/opt/python/libexec/bin
